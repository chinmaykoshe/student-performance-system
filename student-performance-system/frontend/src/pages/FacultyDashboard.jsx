...
const FacultyDashboard = () => {
  ...
  const handleAddAssessment = useCallback(async (e) => {
    ...
    try {
      ...
      if (res.data && res.data.success) {
        // For now we only close the modal and refresh student row prediction.
        // Backend creates a SkillAssessment; predictions are driven by academic metrics.
  ...
  return (
    <div className="flex-1 flex flex-col min-w-0 overflow-y-auto bg-slate-50 text-slate-900">
      ...
      <PageShell maxWidth="max-w-7xl">
          ...
          {/* Dashboard Tabs Selector removed */}
